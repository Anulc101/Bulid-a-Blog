...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://bulid-a-blog:anulc101@localhost:3306/bulid-a-blog'
...
def new_entry():
    ...
    if request.method == 'POST':
        ...
        return render_template('new_entry_form.html', title="Add a blog entry")
#
